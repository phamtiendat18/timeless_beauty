...
const SignUp = () => {
  ...
  return (
    <div>
      <Header path1={"Đăng ký tài khoản"} />
      <div className="w-[622px] mx-auto bg-white shadow-lg rounded-lg p-[51px] mt-[60px] mb-[80px]">
        ...
        <p className="text-center text-[24px] mb-[30px]">
          Bạn đã có tài khoản,{" "}
          <Link to={"/login"} className="text-[#F88CADE5]">
            đăng nhập
          </Link>{" "}
          tại đây
        </p>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-[20px]">
            <Checkbox /> <span className="ml-[8px]">Tôi đồng ý với&nbsp;</span>
            <span className="text-[#F88CAD]">Điều khoản dịch vụ</span> và
            <span className="text-[#F88CAD]">
